<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header bg-dark text-light">
            <h5 class="modal-title">Edit Pizza: {{ $pizza->name }}</h5>
        ...
        <div class="modal-body">
            <form action="{{ route('pizzas.update', $pizza) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pizzaName" name="name" value="{{ $pizza->name }}" required>
                </div>
                <div class="mb-3">
            ...
            <form id="delete-pizza-form-{{ $pizza->id }}" action="{{ route('pizzas.destroy', $pizza) }}" method="POST" style="display: none;">
                @csrf
                @method('DELETE')
            </form>
        </div>
